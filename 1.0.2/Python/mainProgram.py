...
modules.general.menu('Please select an action:',['Export the processed data to a spreadsheet (csv)','Plot the trajectory','Generate a 3D reconstitution of the flight'])